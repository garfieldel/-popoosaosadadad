	...
	override function update(elapsed:Float)
	{
		...
		if (!movedBack)
		{
			if (!selectedWeek)
			{
				...
				if (controls.RIGHT #if mobile || virtualPad.buttonRight.justPressed #end)
					rightArrow.animation.play('press')
				else
					rightArrow.animation.play('idle');

				if (controls.LEFT #if mobile || virtualPad.buttonLeft.justPressed #end)
		...
		if (controls.BACK #if mobile || virtualPad.buttonB.justPressed #end && !movedBack && !selectedWeek)
		{
