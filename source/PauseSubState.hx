...
class PauseSubState extends MusicBeatSubstate
{
	...
	public function new(x:Float, y:Float)
	{
		...
		if (PlayState.SONG.song.toLowerCase() == "termination") //Scuffed code but whatever.
			levelDifficulty.text += "VERY HARD";
		else if (PlayState.SONG.song.toLowerCase() == "cessation")
			levelDifficulty.text += "FUTURE";
		else
	...
	override function update(elapsed:Float)
	{
		...
		var leftP = controls.LEFT_P #if mobile || virtualPad.buttonLeft.justPressed #end;
		var rightP = controls.RIGHT_P #if mobile || virtualPad.buttonRight.justPressed #end;
